    ...
    <div class="container requests">
        ...
        <c:choose>
            ...
            <c:otherwise>
                ...
                <%-- Get a full list of all submissions by type 'Approval' --%>
                <div class="list">
                  <c:choose>
                                    ...
                                    <div class="panel-body text-center">
                                        ...
                                        <div class="col-sm-8">
                                            <span class="pull-left text-left panel__valign-text">
                                                ...
                                                <div class="font-bold gray" >${text.escape(i18n.translate(submission.coreState))} :
                                                    <c:choose>
                                                ...
                                                <p class="gray-dark"><strong>${text.escape(i18n.translate(submission.form,submission.label))}</strong></p>
                                            </span>
                                        </div>
                                        <div class="col-sm-2">
                                            <span class="pull-right text-left panel__valign-buttons">
                                                ...
                                                <a href="${bundle.spaceLocation}/submissions/${submission.id}?review">
                                                    <button class="btn btn-primary">${i18n.translate("Review")}
                                                    <i class="icon-control-feedback fa fa-chevron-right"></i>
                                                    </button>
                                                </a>
                                            </span>
