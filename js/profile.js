        ...
        $('button.save-profile').on('click', function(e){
            ...
            $.ajax({
                ...
                success: function(data, textStatus, jqXHR){
                    $('div.profile').notifie({
                        severity: 'success',
                        message: K.translate('bundle','Saved changes to user ') + data.user.displayName,
                        expire: 5000
                    });
                },
                ...
                complete: function(jqXHR, settings){
                    /* If the user changes thier language preferance the page will be reloaded.
                     * That way the user will see the page in thier selected language.
                     */
                    if(bundle.config.userLocale !== jqXHR.responseJSON.user.preferredLocale){
